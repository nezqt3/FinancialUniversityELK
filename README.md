...
Репозиторий собирает полный стек «NoMissed»: текстового бота MAX, мини-приложения с интерфейсом MAX UI и вспомогательного API со scrapping-сервисами. Проект можно использовать как демо-решение для хакатона или как основу собственного чат-бота с мини-приложением.
